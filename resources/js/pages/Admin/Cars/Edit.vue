...
const breadcrumbs = [
    ...
    { title: 'Edit Car', href: `/admin/cars/${props.car.id}/edit` },
];
...
const form = useForm({
    ...
    availability: props.car.availability ? true : false,
    image: null,
});

// Preview old image if exists
const previewImage = ref(props.car.image_url);
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto mt-8 w-[900px] rounded-lg border border-green-300 bg-white shadow">
            <h1 class="mb-6 rounded-t-lg bg-green-600 py-2 text-center text-2xl font-semibold text-white">Edit Car</h1>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <select v-model="form.car_type" class="w-full rounded border border-gray-300 p-2 focus:border-green-500 focus:outline-none">
                            <option :value="null" disabled>Select Car Type</option>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            class="w-full rounded border border-gray-300 p-2 focus:border-green-500 focus:outline-none"
                        >
                            <option :value="null" disabled>Select Availability Status</option>
